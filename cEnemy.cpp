...
cEnemy::cEnemy(int posx, int posy, int width, int height)
{
	x = posx;
	y = posy;
	w = width;
...
void cEnemy::SetWidthHeight(int width, int height)
{
	w = width;
	h = height;
}
void cEnemy::GetWidthHeight(int *width, int *height)
{
	*width = w;
	*height = h;
}
